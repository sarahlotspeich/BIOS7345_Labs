...
{
  f <- (rchisq(n = 1, df = degrees_freedom_num, ncp = 2*ncp)/df_num)/(rchisq(n = 1, df = degrees_freedom_denom)/df_denom)
  return(f)
}
#test your function
...
Plot the density of the observed non-central F observations with a range of 0 to 20 on the x-axis.
...
xtable(x = tab,
       caption = "\\label{tab1}Comparing the mean/variance of central and non-central distributions.")
